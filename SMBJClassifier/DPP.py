...
def LPF_10kHz():
    ...
    lpf = signal.remez(
        numtaps=N+1,            # Desired number of taps
        bands=[0., Fpb/Fs, Fsb/Fs, .5], # Filter inflection points
        desired=[1,0],          # Desired gain for each of the bands: 1 in the pass band, 0 in the stop band
